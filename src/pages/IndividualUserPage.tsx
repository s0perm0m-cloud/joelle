  ...
  return (
    ...
    >
      <div className="w-full max-w-lg p-8 space-y-6 bg-white bg-opacity-20 backdrop-blur-lg rounded-xl shadow-2xl">
        ...
        <div className="mt-6">
          <h3 className="text-2xl font-bold text-center text-white">Personality Test (FOC)</h3>
          <p className="text-center text-white">Discover your strengths and best-suited roles.</p>
